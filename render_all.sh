echo "This contains two passes using ICL code to render the office room dataset. Da Kong, 12-8-2022"

cd icl-office/

echo "Now, the first pass works."

"/usr/local/bin/povray" +Ioffice.pov +Oscene_000.png +W640 +H480 \
 ...
 Declare=val00=0.998739  Declare=val01=0.00725321  Declare=val02=-0.0496855 Declare=val10=0.00725319  Declare=val11=0.958294  Declare=val12=0.285692 Declare=val20=0.0496855  Declare=val21=-0.285692  Declare=val22=0.957033 Declare=val30=91  Declare=val31=465  Declare=val32=-292 

echo "Now, the second pass works."
